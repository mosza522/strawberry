          ...
          <div class="">
            ...
            <div class="clearfix"></div>
             <div class="row">
			  ...
			  <div class="title_left">
						<h4><a href="header_management.php?page=home_keywords">Keywords</a> > Add Keywords</a></h4>
			  </div>
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add Keywords</h2>
				...
				<!-- --------------------End DropDown List Get Catagory Blade-------------------------------- -->
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea name="keywords" class="form-control col-md-7 col-xs-12" style="margin: 0px; width: 500px; height: 130px;"></textarea>
                        </div>
                      </div>
