    ...
    <div class="container body">
      <div class="main_container">
        ...
        <form  class="form-horizontal form-label-left" method="post" action="header_management/update.php"  enctype="multipart/form-data">
				...
				<?php $sql_edit="SELECT * FROM description WHERE description_id='{$_GET['id']}'" ;
				$rs_edit=mysql_fetch_array(mysql_query($sql_edit));
				?>
				<input type="hidden" name="id_description" value="<?=$_GET['id']?>">
				...
				<!-- --------------------End DropDown List Get Catagory Blade-------------------------------- -->
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea name="description" class="form-control col-md-7 col-xs-12" style="margin: 0px; width: 500px; height: 130px;"><?=$rs_edit['description']?></textarea>
                        </div>
                      </div>
