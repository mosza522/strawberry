...
function change_content_th(){
  ...
  if(editorTextth==""){
    document.getElementById('content_preview_th').innerHTML="ติดต่อเรา";
}else{
...
function change_content_en(){
  ...
  if(editorTexten==""){
    document.getElementById('content_preview_en').innerHTML="Contact us";
  }else{
...
<div class="title_left">
    <h4>Content > Content Contact</h4>
</div>
        <div class="x_panel">
          <div class="x_title">
            <h2>Add Content Contact</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <br />
          <form class="" action="content/add.php" method="post">
            <input type="hidden" name="content_page" value="12">
...
function del()
{
  bootbox.confirm({
    ...
    callback: function (result) {
      if(result == true)
      {
        window.location.href="delcontent.php?content=12";
      }
    }
  });
