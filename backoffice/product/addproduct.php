          ...
          <div class="">
            ...
            <div class="clearfix"></div>
             <div class="row">
			  ...
			  <div class="title_left">
						<h4><a href="product.php?page=home&active=product">product</a> > Add product</a></h4>
			  </div>
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add product</h2>
                  ...
                  <div class="x_content">
                    <br />
        <form name="form1" onsubmit="return OnUploadCheck()"  class="form-horizontal form-label-left" method="post" action="product/add.php"  enctype="multipart/form-data">
        ...
        <div class="col-md-3 col-sm-3 col-xs-12">
          <button type="button" class="btn btn-info" onclick="location.href = 'product.php?page=addproduct_category&active=product'"><i class="fa fa-plus-square"></i> Add product category</button>
        </div>
      </div>
                   ...
                   <div class="col-md-6 col-sm-6 col-xs-12">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                         ...
                         <div class="col-md-6 col-sm-6 col-xs-12">
                           <input type="text" value="10" name="product_price_retail" required="required" class="form-control col-md-7 col-xs-12">
                         </div>
                       </div>
                       <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" value="70" name="product_price_dozen" required="required" class="form-control col-md-7 col-xs-12">
                          </div>
                        </div>
                        <div class="form-group">
                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                             <input type="text" name="product_price_crate" required="required" class="form-control col-md-7 col-xs-12">
                           </div>
                         </div>
					  <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Picture<span class="required">*</span>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="reset" class="btn btn-primary" onclick="location.href='product.php?page=home&active=product'">Back</button>
                        </div>
                      </div>
                    </form>
        ...
        <script language="JavaScript">
        	function OnUploadCheck()
        	{
        		...
        		file = document.form1.product_file.value;
