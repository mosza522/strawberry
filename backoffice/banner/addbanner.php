          ...
          <div class="">
            ...
            <div class="clearfix"></div>
             <div class="row">
			  ...
			  <div class="title_left">
						<h4><a href="banner.php?page=home&active=banner">Banner</a> > Add Banner</a></h4>
			  </div>
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add Banner</h2>
                  ...
                  <div class="x_content">
                    <br />
        <form name="form1"  class="form-horizontal form-label-left" method="post" action="banner/add.php"  enctype="multipart/form-data" onSubmit="return OnUploadCheck();">
        ...
        <div class="col-md-3 col-sm-3 col-xs-12">
          <button type="button" class="btn btn-info" onclick="location.href = 'banner.php?page=addbanner_type&active=banner'"><i class="fa fa-plus-square"></i> Add Banner Page</button>
        </div>
      </div>
              ...
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Picture<span class="required">*</span>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="reset" class="btn btn-primary" onclick="location.href='banner.php?page=home&active=banner'">Back</button>
                        </div>
                      </div>
                    </form>
