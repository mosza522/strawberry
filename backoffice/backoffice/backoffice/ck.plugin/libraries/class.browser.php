		...
		*/
	    ...
	    protected function checkBrowserInternetExplorer() {
		    ...
		    // Test for versions > 1.5
				...
				if( stripos($this->_agent,'Trident') ){
					$this->setBrowser('IE Compatibility Mode');
					$this->setVersion('9.0');
				}else{
					$this->setBrowser( self::BROWSER_IE );
					$this->setVersion(str_replace(array('(',')',';'),'',$aresult[1]));
	    ...
	    protected function checkPlatform() {
		    if( stripos($this->_agent, 'Windows NT 7.0') !== false || stripos($this->_agent, 'Windows NT 6.1') !== false ) {
			    $this->_platform = self::PLATFORM_WINDOWS .' 7';
		    }
			else if( stripos($this->_agent, 'Windows NT 6.0') !== false || stripos($this->_agent, 'Windows Vista 6.0') !== false ) {
			    $this->_platform = self::PLATFORM_WINDOWS .' Vista';
		    }
			else if( stripos($this->_agent, 'Windows NT 4.0') !== false || stripos($this->_agent, 'WinNT4.0') !== false || stripos($this->_agent, 'WinNT') !== false ) {
			    $this->_platform = self::PLATFORM_WINDOWS .' NT 4.0';
		    }
			else if( stripos($this->_agent, 'Windows NT 5.2') !== false ) {
			    $this->_platform = self::PLATFORM_WINDOWS .' 2003';
		    }
			else if( stripos($this->_agent, 'Windows NT 5.1') !== false || stripos($this->_agent, 'Windows XP') !== false ) {
			    $this->_platform = self::PLATFORM_WINDOWS .' XP';
		    }
			else if( stripos($this->_agent, 'Windows NT 5.0') !== false || stripos($this->_agent, 'Windows 2000') !== false ) {
			    $this->_platform = self::PLATFORM_WINDOWS .' 2000';
		    }
			else if( stripos($this->_agent, 'Windows ME') !== false || stripos($this->_agent, 'Win 9x 4.90') !== false ) {
			    $this->_platform = self::PLATFORM_WINDOWS .' ME';
		    }
