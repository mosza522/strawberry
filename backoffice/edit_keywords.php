    ...
    <div class="container body">
      <div class="main_container">
        ...
        <form  class="form-horizontal form-label-left" method="post" action="header_management/update.php"  enctype="multipart/form-data">
				...
				<?php $sql_edit="SELECT * FROM keywords WHERE keywords_id='{$_GET['id']}'" ;
				$rs_edit=mysql_fetch_array(mysql_query($sql_edit));
				?>
				<input type="hidden" name="id_keywords" value="<?=$_GET['id']?>">
				<div class="form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> Page <span class="required">*</span>
        </label>
                    <div class="col-md-3 col-sm-3 col-xs-12">

            <select name="page_id_keywords" id="" class="form-control" required>
              ...
              <?php
                ...
                while ($rs=mysql_fetch_array($q)) {
                  ...
                  $sql_check="SELECT page_id FROM keywords WHERE page_id='$rs[page_id]'";
				...
				<!-- --------------------End DropDown List Get Catagory Blade-------------------------------- -->
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea name="keywords" class="form-control col-md-7 col-xs-12" style="margin: 0px; width: 500px; height: 130px;"><?=$rs_edit['keywords']?></textarea>
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="reset" class="btn btn-primary" onclick="location.href='header_management.php?page=home_keywords'">Back</button>
                        </div>
                      </div>
										</form>
                      </div>
